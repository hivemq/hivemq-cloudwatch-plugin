...
If you want to contribute to HiveMQ Cloudwatch Plugin, see the link:CONTRIBUTING.md[contribution guidelines].

= License

HiveMQ Cloudwatch Plugin is licensed under the `APACHE LICENSE, VERSION 2.0`. A copy of the license can be found link:LICENSE.txt[here].
